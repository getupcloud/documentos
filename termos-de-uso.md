...
TERMO DE USO DOS SERVIÇOS DA GETUP
----------------------------------
...
A Getup é uma plataforma de hospedagem e gerenciamento de aplicativos hospedados em ambiente de nuvem que proporciona escalabilidade de recursos, através de solução “PaaS” (Plataform as a Service).

A escalabilidade compreende a liberação de recursos computacionais conforme a demanda. Assim o CLIENTE poderá definir o tamanho da sua estrutura e pagará a quantidade de recursos que utilizar. 

3. CONDIÇÕES DO USO
-------------------

O CLIENTE fará a contratação através do website da Getup, escolhendo a quantidade e limites de recursos computacionais que se ajusta a sua necessidade, conforme explicados aqui. A liberação dos recursos ocorrerá após a validação da contratação pela operadora do cartão de crédito. Estes recursos serão calculados por hora/uso e o montante utilizado no período de 30 (trinta) dias será faturado para cobrança.

O CLIENTE é o único responsável pelo gerenciamento de suas aplicações. Caso suas aplicações demandem mais recursos, esses recursos serão automaticamente liberados até o limite estabelecido pelo CLIENTE.
...
Os preços praticados na TRANSAÇÃO COMERCIAL são aqueles dispostos no próprio Site no ato da contratação do serviço e correspondem ao próprio serviço, levando em conta valores praticados no mercado, assim como demais taxas e tributos.
...
As formas de pagamento ofertados pelo Site são realizados por um sistema seguro, conveniado aos principais bancos brasileiros, que suportam pagamento por cartão de crédito de diversas bandeiras.

As facilidades de pagamento, tais quais parcelas, preços e demais facilidades promocionais, são ofertadas diretamente pela Getup ao CLIENTE, e estarão sempre identificadas no Site.

O CLIENTE declara-se ciente de que ao fornecer os dados do cartão de crédito para o pagamento está concedendo uma AUTORIZAÇÃO PERMANENTE à Getup para que todas as cobranças decorrentes do uso dos serviços sejam debitadas no aludido cartão.

A Getup manterá em seus registros os dados do cartão de crédito fornecidos pelo CLIENTE, ficando expressamente autorizada a utilizá-los para as subsequentes renovações e pagamentos dos recursos utilizados, se assim for o caso.
...
Corre por conta exclusiva do CLIENTE a obrigação de solicitar a cessação dos débitos em seu cartão de crédito. Por isso, visando a melhor prática de consumo por nossos CLIENTES, alertamos para que você utilize com parcimônia e inteligência seu cartão de crédito.
...
O CLIENTE poderá interromper o uso dos serviços da Getup a qualquer tempo. Para isso basta excluir suas aplicações e não mais utilizar o serviço, sem prejuízo dos pagamentos, por ventura, vincendos.

Lamentamos cada cliente que nos deixa e sempre esperamos que eles voltem,  por isso as contas permanecem ativas, ainda que não rodem nenhuma aplicação ou não gerem cobrança.

Caso o CLIENTE deseje utilizar de novo nossos serviços, basta subir suas aplicações novamente ou criar novas, a hora que quiser.

O término na utilização dos serviços Getup ocorrerá sem qualquer direito a reembolso de valores eventualmente pagos e sem prejuízo do direito de recebimento pela Getup da totalidade dos valores referentes ao serviços prestados.

O CLIENTE entende e concorda que pela natureza dos serviços prestados pela Getup, certos planos e serviços oferecidos podem ser descontinuados ou modificados, sem prévio aviso, e tais alterações podem recair sobre o preço, políticas de pagamento, normas de segurança, ou outras funcionalidades.

Respeitando as Leis brasileiras e melhores práticas de consumo, e considerando que pela natureza dos Serviços prestados, principalmente no que se refere a continuidade deste, a Getup, compromete-se a avisar os CLIENTES por e-mail e na própria plataforma do Site, acerca das mudanças aludidas no parágrafo anterior. Também, no referente ao eventual aumento de preço, é garantido ao CLIENTE, o valor do ato de contratação, ficando o aumento para o período de 30 (trinta) dias subsequente. 

O CLIENTE é o único responsável por exportar o seu conteúdo e aplicativos(s) dos Serviços Getup antes do término da sua conta.
...
Nos comprometemos a empregar nossos melhores esforços para manter os serviços disponíveis de forma ininterrupta. Entretanto, poderão existir causas fora do nosso controle que impossibilite a melhor prestação dos Serviços.

Esta não é uma promessa vazia, pelo contrário, somos bastante criteriosos ao escolher nossos fornecedores de serviços, decidindo por aqueles com melhor conceito no mercado, estrutura mais robusta e com os melhores engenheiros a frente destas infraestruturas.

A Getup não será  responsabilizada, em nenhuma hipótese, por danos ocorridos aos seus CLIENTES no uso de seus serviços, surgidos em virtude da conexão ao seu website na Internet, comunicação com seus parceiros, processamento de pagamentos, falhas ou quedas nos SERVIÇOS decorrentes de infraestrutura de telecomunicações, rede de energia elétrica, caso fortuito e força maior entre outros.
...
O presente TERMO DE USO/SERVIÇO constitui o entendimento integral entre o CLIENTE e a Getup e é regido pelas Leis Brasileiras, ficando eleito o foro da cidade de Porto Alegre - RS, como único competente para dirimir questões decorrentes do presente TERMO DE USO/SERVIÇO, com renúncia expressa a qualquer outro foro, por mais privilegiado que seja.
